...
use Clevis\PushNotifications\Exception\InvalidMessageTypeException,
    Clevis\PushNotifications\Message\AppleMessage,
    Clevis\PushNotifications\Message\MessageInterface;
...
class AppleNotification implements OSNotificationServiceInterface
{
     ...
     *
     * @param  \Clevis\PushNotifications\Message\MessageInterface|\Clevis\PushNotifications\Service\OS\MessageInterface $message
     * @throws \RuntimeException
     * @throws \Clevis\PushNotifications\Exception\InvalidMessageTypeException
     * @return bool
     */
